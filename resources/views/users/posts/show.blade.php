                            ...
                            @else
                                @if ($post->user->isFollowed())
                                    <form action="{{ route('follow.destroy', $post->user->id) }}" method="post">
                                        ...
                                        @method('DELETE')
                                        <button type="submit"
                                            class="btn btn-outline-secondary btn-sm fw-bold">Unfollow</button>
                                    </form>
                                @else
                ...
                <div class="card-body w-100">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto px-0">
                            {{-- number of likes --}}
                            button.btn.btn-outline.border-0.<span>{{ $post->likes->count() }}</span>
                        </div>
                        <div class="col text-end">
                            ...
                            @forelse ($post->categoryPost as $category_post)
                                <div class="badge bg-secondary bg-opacity-50"><a
                                        ...
                                        class="text-decoration-none text-white">{{ $category_post->category->name }}</a>
                                </div>
                            @empty
