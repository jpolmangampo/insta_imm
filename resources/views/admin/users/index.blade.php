...
@section('content')
    <div class="text-end mb-3">
        <form action="{{ route('admin.users') }}">
            @csrf
            <label for="search-name" class="form-label text-muted fw-bold">Search user(s) </label>
            <input type="search" name="search_name" id="search-name" class="form-control w-25 d-inline"
                placeholder="Find user name" value="{{ old('search_name', $search_name) }}">
        </form>
    </div>
